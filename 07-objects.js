...
// com os dados do produto e um objeto com as fotos.
// Apesar desse nó de fotos sempre existir, somente a fotoPrincipal virá sempre preenchida,
// já a fotoSecundaria e fotoVerso podem não estarem disponíveis.
// Caso alguma destas duas não exista, deve-se exibir o valor padrão de https://via.placeholder.com/1500 no lugar.
// O objetivo é extrair 3 fotos para o produto.
...
const fotoSecundariaSemDestructuring =
	typeof produto.fotos.fotoSecundaria !== "undefined"
		? produto.fotos.fotoSecundaria
		: "https://via.placeholder.com/1500";
const fotoVersoSemDestructuring =
	typeof produto.fotos.fotoVerso !== "undefined"
		? produto.fotos.fotoVerso
		: "https://via.placeholder.com/1500";
